...
# 绘制大圆路径
open(GMT,"|gmt plot -W1p,red << EOF") or die;
>
...
# 绘制震中位置
open(GMT,"|gmt plot -Sa0.5c -W0.5p,black,solid -Gyellow << EOF") or die;
print GMT "130.72 32.78\n";
close(GMT);

# 绘制台站位置
open(GMT,gmt plot -St0.2c -W0.5p,black,solid -Gblack << EOF
print GMT "104.39 29.90\n";
print GMT "13.14 52.50\n";
print GMT "19.99 -34.52\n";
print GMT "-77.15 38.89\n";
